...
- TUF-authenticated catalog/advisory refresh, retained release identities, expiry/rollback enforcement and offline cache behavior. The production publisher remains disabled until the post-merge live check; existing unsigned metadata cannot authorize new downloads in 0.6.0.
