...
The [release procedure](../releasing.md) describes repeatable preparation. [Packaged client-update acceptance](app-updates.md) remains separate: a private draft cannot be discovered through the public updater feed. Catalog live acceptance (#46), final Windows/game/accessibility acceptance and user documentation (#30) remain required before public release. Windows publisher certificates remain deferred to #61.
