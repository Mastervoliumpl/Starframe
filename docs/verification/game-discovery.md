...
The required GitHub status must pass before merging this completion record. It includes repository, frontend and Windows jobs. A local build is not evidence of a hosted-runner result.
