...
4. Select the collection you want to use and enable the imported build. Install or import its declared dependencies first. Select the game installation in Settings; Starframe prepares its runtime automatically while the game is closed.
