...
Milestone **0.2.0** is active. The first change adds the C# runtime project and shared activation contracts; it does not yet load mods or change game files. See [runtime verification](docs/verification/runtime-contracts.md).
