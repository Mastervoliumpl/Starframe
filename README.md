...
Milestone **0.2.0** is active. The branch adds the C# runtime contracts and a guarded development command for reversible BepInEx bootstrap installation/removal. Desktop setup controls and mod loading are not yet connected. See [bootstrap commands and recovery](docs/verification/bootstrap.md). See [runtime verification](docs/verification/runtime-contracts.md).
