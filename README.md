...
Milestone **0.1.1** is active at development version **0.1.1-dev.1**. Issue #39 proves Turso-to-SQLite conversion in isolated tests; the application still uses Turso until #40 replaces the engine. See the [decision and data-preservation plan](docs/planning/sqlite-transition.md).
