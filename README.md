...
Milestone **0.3.0** is active on the development branch at `0.3.0-dev.1`, starting with issue #16. [Catalog metadata and validation](catalog/README.md), automatic refresh, SQLite caching and visible check status are implemented. Catalog publication awaits merge to main. Package downloads and management screens are still planned; the initial catalog is empty.
