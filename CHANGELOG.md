...
- Add a bounded TUF catalog/advisory verifier with signature, expiry, rollback and retained key-rotation tests (#46). Advisory corrections retain history; schema 13 commits both verified targets together. Daily renewal with thirty-day validity is approved; desktop refresh, download enforcement and publishing integration remain in progress.
