...
The owner approved the expired-metadata behavior for #46 on 9 September 2026: pause new catalog downloads until a valid signed refresh succeeds. Installed mods remain usable offline, subject to cached confirmed security findings. Show when catalog information is stale or unknown. The signing implementation and renewal interval remain pending; this decision does not change the current unsigned client by itself.
